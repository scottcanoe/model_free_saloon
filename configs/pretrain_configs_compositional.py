...
pretrain_bio_compositional = dict(
    ...
    logging_config=PretrainLoggingConfig(
        ...
        run_name="pretrain_bio_compositional",
    ),
    ...
    dataset_args=make_dataset_args("compositional_objects"),
...
set_view_finder_gsg(pretrain_bio_compositional, OnObjectGsgBio)
CONFIGS["pretrain_bio_compositional"] = pretrain_bio_compositional

pretrain_standard_compositional = copy.deepcopy(pretrain_bio_compositional)
pretrain_standard_compositional["logging_config"].run_name = "pretrain_standard"
pretrain_standard_compositional["monty_config"].sensor_module_configs["sensor_module_0"] = (
    patch_config_no_fc
)
set_view_finder_gsg(pretrain_standard_compositional, None)
pretrain_standard_compositional["monty_config"].motor_system_config=MotorSystemConfigNaiveScanSpiral(
            motor_system_args=dict(
                policy_class=NaiveScanPolicy,
                policy_args=make_naive_scan_policy_config(step_size=5),
            )
)
CONFIGS["pretrain_standard_compositional"] = pretrain_standard_compositional
